...
const UUID = process.env.UUID || '1a8e006b-eb1d-4a4a-b0ec-9c662a24b86e'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'gyy123k.unryaton.qzz.io';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiODMxZGZiODVjOTRlYjE4ZDIwOTY5MjBhNTI5YTMxNDIiLCJ0IjoiOTllNzJlN2ItNDU0Yy00M2IwLWIyOGEtZjI2YTU5MGE4MGE2IiwicyI6Ik5EQmlOVGRqTlRFdFpUUTNZUzAwTnpFd0xUa3haREF0TWpVM016SXdaak16WVRBNCJ9';   
...
const NAME = process.env.NAME || 'gp66';                        // 节点名称
